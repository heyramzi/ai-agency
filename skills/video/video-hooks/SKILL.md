...
What this skill's own runs have taught it, newest first, kept out of the body so the rules above carry the cost and the evidence does not. Append with `skill-manager log`. See [`references/learned-patterns.md`](references/learned-patterns.md).
